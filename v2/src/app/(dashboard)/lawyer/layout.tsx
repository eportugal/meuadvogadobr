...
export default function LawyerLayout({
  ...
  const menuItems = [
    { href: "/lawyer/painel", icon: LayoutDashboard, label: "Painel" },
    { href: "/lawyer/tickets", icon: FileText, label: "Tickets" },
    { href: "/lawyer/agenda", icon: Calendar, label: "Agenda" },
    { href: "/lawyer/configuracoes", icon: Settings, label: "Configurações" },
  ];
    ...
    <div className="flex h-screen">
      ...
      >
        <div className="flex h-full flex-col">
          <div className="flex h-16 items-center border-b px-6">
            <h2 className="text-lg font-semibold">Portal do Advogado</h2>
          </div>
      ...
      <div className="flex flex-1 flex-col">
        <header className="flex h-16 items-center gap-4 border-b px-6 lg:hidden">
          ...
          <h1 className="text-lg font-semibold">Portal do Advogado</h1>
        </header>
